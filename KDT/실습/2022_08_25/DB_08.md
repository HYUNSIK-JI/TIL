...
for i in range(len(movies)):
    ...
    title_ = movies[i][2]
    opening_date_ = movies[i][3]
    running_time_ = movies[i][4]
    screening_ = movies[i][5]
...
for i in range(len(movie)):
    print(movie[i].director, movie[i].genre, movie[i].title, movie[i].opening_date, movie[i].running_time, movie[i].screening)
```
...
movie = Movie.objects.all()
for i in range(len(movie)):
    k = movie[i].director.name
    print(k, movie[i].genre, movie[i].title, movie[i].opening_date, movie[i].running_time, movie[i].screening)
```
...
for i in range(len(movie)):
    k = movie[i].director.name
    k1 = movie[i].genre.title
    print(k, k1, movie[i].title, movie[i].opening_date, movie[i].running_time, movie[i].screening)
```
...
for i in range(len(movie)):
    k = movie[i].director.name
    k1 = movie[i].genre.title
    print(movie[i].director.name, movie[i].genre.title, movie[i].title, movie[i].opening_date, movie[i].running_time, movie[i].screening)
```
...
```python
movie = Movie.objects.all().order_by('running_time')
for i in range(len(movie)):
    k = movie[i].director.name
    k1 = movie[i].genre.title

    if movie[i].running_time >= 119:
        print(k, k1, movie[i].title, movie[i].opening_date, movie[i].running_time, movie[i].screening)
```
